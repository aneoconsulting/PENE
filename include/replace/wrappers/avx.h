    ...
    namespace wrappers
    {
      namespace avx
      {
        ...
        struct wrap {
          ...
          template <int N>
          static void apply(INS ins, bool is_memory, REG tmp_reg1, REG tmp_reg2)
          {
            ...
            {
              INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)copy_register<N * sizeof(T)>,
        ...
        void instrument(INS ins, REG tmp_reg1, REG tmp_reg2)
        {
          ...
          case xed_iform_enum_t::XED_IFORM_VADDSS_XMMdq_XMMdq_XMMd:
            wrap<float, OPERATION_IMPL::add_float>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDSS_XMMdq_XMMdq_MEMd:
            wrap<float, OPERATION_IMPL::add_float>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VADDPS_XMMdq_XMMdq_XMMdq:
            wrap<float, OPERATION_IMPL::add_float>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDPS_XMMdq_XMMdq_MEMdq:
            wrap<float, OPERATION_IMPL::add_float>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VADDPS_YMMqq_YMMqq_YMMqq:
            wrap<float, OPERATION_IMPL::add_float>::apply<8>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDPS_YMMqq_YMMqq_MEMqq:
            wrap<float, OPERATION_IMPL::add_float>::apply<8>(ins, true, tmp_reg1, tmp_reg2);
            break;



          case xed_iform_enum_t::XED_IFORM_VADDSD_XMMdq_XMMdq_XMMq:
            wrap<double, OPERATION_IMPL::add_double>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDSD_XMMdq_XMMdq_MEMq:
            wrap<double, OPERATION_IMPL::add_double>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VADDPD_XMMdq_XMMdq_XMMdq:
            wrap<double, OPERATION_IMPL::add_double>::apply<2>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDPD_XMMdq_XMMdq_MEMdq:
            wrap<double, OPERATION_IMPL::add_double>::apply<2>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VADDPD_YMMqq_YMMqq_YMMqq:
            wrap<double, OPERATION_IMPL::add_double>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VADDPD_YMMqq_YMMqq_MEMqq:
            wrap<double, OPERATION_IMPL::add_double>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;
          ...
          case xed_iform_enum_t::XED_IFORM_VSUBSS_XMMdq_XMMdq_XMMd:
            wrap<float, OPERATION_IMPL::sub_float>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBSS_XMMdq_XMMdq_MEMd:
            wrap<float, OPERATION_IMPL::sub_float>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VSUBPS_XMMdq_XMMdq_XMMdq:
            wrap<float, OPERATION_IMPL::sub_float>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBPS_XMMdq_XMMdq_MEMdq:
            wrap<float, OPERATION_IMPL::sub_float>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VSUBPS_YMMqq_YMMqq_YMMqq:
            wrap<float, OPERATION_IMPL::sub_float>::apply<8>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBPS_YMMqq_YMMqq_MEMqq:
            wrap<float, OPERATION_IMPL::sub_float>::apply<8>(ins, true, tmp_reg1, tmp_reg2);
            break;



          case xed_iform_enum_t::XED_IFORM_VSUBSD_XMMdq_XMMdq_XMMq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBSD_XMMdq_XMMdq_MEMq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VSUBPD_XMMdq_XMMdq_XMMdq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<2>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBPD_XMMdq_XMMdq_MEMdq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<2>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VSUBPD_YMMqq_YMMqq_YMMqq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VSUBPD_YMMqq_YMMqq_MEMqq:
            wrap<double, OPERATION_IMPL::sub_double>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;
          ...
          case xed_iform_enum_t::XED_IFORM_VMULSS_XMMdq_XMMdq_XMMd:
            wrap<float, OPERATION_IMPL::mul_float>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULSS_XMMdq_XMMdq_MEMd:
            wrap<float, OPERATION_IMPL::mul_float>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VMULPS_XMMdq_XMMdq_XMMdq:
            wrap<float, OPERATION_IMPL::mul_float>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULPS_XMMdq_XMMdq_MEMdq:
            wrap<float, OPERATION_IMPL::mul_float>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VMULPS_YMMqq_YMMqq_YMMqq:
            wrap<float, OPERATION_IMPL::mul_float>::apply<8>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULPS_YMMqq_YMMqq_MEMqq:
            wrap<float, OPERATION_IMPL::mul_float>::apply<8>(ins, true, tmp_reg1, tmp_reg2);
            break;



          case xed_iform_enum_t::XED_IFORM_VMULSD_XMMdq_XMMdq_XMMq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULSD_XMMdq_XMMdq_MEMq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VMULPD_XMMdq_XMMdq_XMMdq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<2>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULPD_XMMdq_XMMdq_MEMdq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<2>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VMULPD_YMMqq_YMMqq_YMMqq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VMULPD_YMMqq_YMMqq_MEMqq:
            wrap<double, OPERATION_IMPL::mul_double>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;
          ...
          case xed_iform_enum_t::XED_IFORM_VDIVSS_XMMdq_XMMdq_XMMd:
            wrap<float, OPERATION_IMPL::div_float>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVSS_XMMdq_XMMdq_MEMd:
            wrap<float, OPERATION_IMPL::div_float>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VDIVPS_XMMdq_XMMdq_XMMdq:
            wrap<float, OPERATION_IMPL::div_float>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVPS_XMMdq_XMMdq_MEMdq:
            wrap<float, OPERATION_IMPL::div_float>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VDIVPS_YMMqq_YMMqq_YMMqq:
            wrap<float, OPERATION_IMPL::div_float>::apply<8>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVPS_YMMqq_YMMqq_MEMqq:
            wrap<float, OPERATION_IMPL::div_float>::apply<8>(ins, true, tmp_reg1, tmp_reg2);
            break;



          case xed_iform_enum_t::XED_IFORM_VDIVSD_XMMdq_XMMdq_XMMq:
            wrap<double, OPERATION_IMPL::div_double>::apply<1>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVSD_XMMdq_XMMdq_MEMq:
            wrap<double, OPERATION_IMPL::div_double>::apply<1>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VDIVPD_XMMdq_XMMdq_XMMdq:
            wrap<double, OPERATION_IMPL::div_double>::apply<2>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVPD_XMMdq_XMMdq_MEMdq:
            wrap<double, OPERATION_IMPL::div_double>::apply<2>(ins, true, tmp_reg1, tmp_reg2);
            break;

          case xed_iform_enum_t::XED_IFORM_VDIVPD_YMMqq_YMMqq_YMMqq:
            wrap<double, OPERATION_IMPL::div_double>::apply<4>(ins, false, tmp_reg1, tmp_reg2);
            break;
          case xed_iform_enum_t::XED_IFORM_VDIVPD_YMMqq_YMMqq_MEMqq:
            wrap<double, OPERATION_IMPL::div_double>::apply<4>(ins, true, tmp_reg1, tmp_reg2);
            break;
