...
# parses the tokens(instruction forms), calls all the previous functions in order to form python objects, theses python objects contain the informations needed by the template      
